Feature: DELETE messages that belong to a conversation, as Authenticated user.
 ...
 Scenario: Messages deleted.
   #When I request "DELETE /cs-pm-api/v1/conversations/{conversation_id}/messages/delete"
   When I request "DELETE /cs-pm-api/v1/conversations/1/messages/delete"
...
Scenario: Validation issue, most likely that ids array is missing.
   #When I request "DELETE /cs-pm-api/v1/conversations/{conversation_id}/messages/delete"
   When I request "DELETE /cs-pm-api/v1/conversations/test/messages/delete"
   Then I should get a 400 HTTP response
   
   
Scenario: Content not found.
   #When I request "DELETE /cs-pm-api/v1/conversations/{conversation_id}/messages/delete"
   When I request "DELETE /cs-pm-api/v1/conversations/55/messages/delete"
